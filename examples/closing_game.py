...
pA, pB = PLAYERS = players('A', 'B')
H, D, C_h, C_c, S, I, P, Up, Um, A = ACTIONS = actions(
    'H', 'D', 'C_h', 'C_c', 'S', 'I', 'P', 'U+', 'U-', 'A'
)
alpha, epsilon, rho = INFINITESIMALS = infinitesimals(
    'alpha', 'epsilon', 'rho')
a, b, c, f, d_A, d_B, p_A, p_B = CONSTANTS = constants(
                ...
                A: branch(pB, {
                    ...
                    I: branch(pA, {
                        ...
                        D: branch(pB, {
                            ...
                            I: leaf2(d_A + rho + alpha -
                                     epsilon, -d_A + rho + alpha)
                        })
                    })
                })
                }),
